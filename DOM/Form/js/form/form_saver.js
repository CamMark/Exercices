...
if (formData) {
    ...
    document.getElementById('grade').value = formData.grade ? formData.grade: "";
    document.getElementById('title').value = formData.title ? formData.title: "";
    document.getElementById('message').value = formData.message ? formData.message: "";
 }